...
<!-- wp:group {"metadata":{"name":"Archive Title"},"style":{"spacing":{"padding":{"top":"0px","bottom":"0px"},"margin":{"top":"0","bottom":"0"}},"dimensions":{"minHeight":""},"background":{"backgroundImage":{"url":"<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/a-left-6-rev-1.svg","id":4027,"source":"file","title":"a-left-6-rev (1)"},"backgroundSize":"65%","backgroundPosition":"100% 0%","backgroundRepeat":"no-repeat"},"elements":{"link":{"color":{"text":"var:preset|color|contrast-content"}}},"border":{"radius":"0px"}},"backgroundColor":"contrast-background","textColor":"contrast-content","layout":{"type":"constrained","contentSize":"700px"}} -->
